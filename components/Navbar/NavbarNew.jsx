...
const GlassNavigation = () => {
    ...
    return (
        <nav
        ref={navRef}
        className="glass-nav fixed left-0 right-0 top-0 z-50 mx-auto max-w-[35rem] overflow-hidden bg-gradient-to-br from-white/20 to-white/5 backdrop-blur md:left-6 md:right-6 md:top-6 md:rounded-2xl"
        >
...
const Links = () => {
    ...
    return (
        ...
        <div className="hidden items-center gap-2 md:flex z-[999] ">
            <ul className="flex w-[20rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium sm:w-[initial] sm:flex-nowrap sm:gap-5">
                {links.map((link) => (
                    <motion.li
